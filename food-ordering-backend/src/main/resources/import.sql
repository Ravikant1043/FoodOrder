insert into foodorderdb.user (id, address, deleted, email, first_name, last_name, password, phone_number, role, username) values (1, "Patna", false, "abcdefghij@gmail.com", "Ravikant", "Sharma", "123", "060123456", 1, "a");
